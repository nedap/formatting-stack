(ns unit.formatting-stack.compilers.test-runner
  (:require
   [clojure.string :as string]
   [clojure.test :refer :all]
   [formatting-stack.compilers.test-runner :as sut]
...
(deftest add-t
  (are [input expected] (= expected
    ...
    ::foo     "unit.formatting-stack.compilers.test-runner.t-foo"
    ::foo.bar "unit.formatting-stack.compilers.test-runner.foo.t-bar"))
...
(deftest testable-namespaces
  (are [input expected] (= expected
    ...
    ["project.clj"
     "test/unit/formatting_stack/compilers/test_runner.clj"
     "/"]
    [(the-ns 'unit.formatting-stack.compilers.test-runner)]
